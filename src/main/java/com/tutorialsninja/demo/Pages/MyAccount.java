...
public class MyAccount extends Utility {
    ...
    public void setFirstName(){
        sendTextToElement(firstName, "Chmpa" + getAlphaNumericString(4));
    }

    public void setLastName(){
        sendTextToElement(lastName, "Chameli" + getAlphaNumericString(4));
    }

    public void setEmailName(){
        sendTextToElement(email, "champa" + getAlphaNumericString(4) + "@gmail.com");
    }

    public void setEmaiLogin(){
        sendTextToElement(email, "champa1233@gmail.com");
    }

    public void setTelephone(){
        sendTextToElement(telephone, "01236548533");
    }

    public void setPassword(){
        sendTextToElement(password, "Monday@123");
    }

    public void setConfirmPassword(){
        sendTextToElement(confirmPassword, "Monday@123");
    }
